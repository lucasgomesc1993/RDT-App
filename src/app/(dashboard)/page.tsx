    ...
    <div className="max-w-7xl mx-auto space-y-10 animate-in fade-in duration-1000 pb-20 pt-4">
      ...
      <div className="grid gap-6 md:grid-cols-3 px-4 md:px-0">
        {[
          ...
          <div key={i} className="group relative overflow-hidden rounded-2xl border border-border/30 dark:border-border/50 bg-card/20 dark:bg-card/40 p-8 transition-all duration-300 hover:bg-muted/10 dark:hover:bg-muted/20 shadow-sm">
