    ...
    <div className="flex min-h-screen w-full items-center justify-center px-4 relative overflow-hidden bg-background">
      ...
      <div className="w-full max-w-[400px] space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="text-center space-y-3">
          ...
          <p className="text-muted-foreground text-sm font-medium opacity-60 px-8">Enviaremos as instruções de acesso para o seu e-mail.</p>
        </div>

        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl p-8 shadow-sm">
          <form className="grid gap-6" action={forgotPassword}>
            <div className="grid gap-2.5">
              <Label htmlFor="email" className="ml-1 text-[10px] font-medium uppercase tracking-widest text-muted-foreground/60">Seu E-mail</Label>
              <Input
                id="email"
                name="email"
                type="email"
        ...
        <div className="text-center">
          <Link href="/login" className="text-xs text-muted-foreground hover:text-foreground transition-colors font-medium">
            ← Voltar para o login
          </Link>
        </div>
      </div>
